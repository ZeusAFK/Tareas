...
using CheckersGame.Resources;
using System.Windows.Media;
using System.Windows.Shapes;
using System.Windows.Input;
using CheckersGame.Code;
...
namespace CheckersGame
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        private void Ellipse_ManipulationStarted_1(object sender, ManipulationStartedEventArgs e)
        {
            ...
            this.currentEllipse = sender as Ellipse;
            // Determinamos el jugador
            this.currentPlayer = GameEngine.GetMovingPlayer(this.currentEllipse);
            ...
            originalBrush = this.currentEllipse.Fill;
            // Se cambia a un color mientras se arrastra
            this.currentEllipse.Fill = new SolidColorBrush(Colors.Blue);
        }
        ...
        private void Ellipse_ManipulationCompleted_1(object sender, ManipulationCompletedEventArgs e)
        {
            ...
            this.currentEllipse.Fill = originalBrush;
